...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'clinserv-engenharia-landing-r9f15.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'ff5e98f49b4d6a5b3e843634a1b16e01';
...
export async function createShopifyCart(item: CartItemData) {
...
export async function addLineToShopifyCart(cartId: string, item: CartItemData) {
